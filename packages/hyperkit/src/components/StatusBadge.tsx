...
const SPECS: Record<BadgeStatus, StatusSpec> = {
  ...
  scheduled: {
    label: "Scheduled",
    glyph: "◷",
    className: "text-neon border-[rgba(101,255,154,0.35)] bg-[rgba(101,255,154,0.06)]",
  },
  transmitting: {
    label: "Transmitting",
    glyph: "⇶",
    className: "text-ice border-[rgba(124,247,255,0.45)] bg-[rgba(124,247,255,0.08)]",
    pulse: true,
  },
  uploading: {
    label: "Uploading",
  ...
  live: {
    label: "Live",
    glyph: "●",
    className: "text-auroral border-[rgba(101,255,154,0.4)] bg-[rgba(101,255,154,0.07)]",
  },
  partial: {
  ...
  failed: {
    label: "Failed",
    glyph: "✕",
    className: "text-redshift border-[rgba(255,113,143,0.4)] bg-[rgba(255,113,143,0.07)]",
    flicker: true,
  },
  retrying: {
    label: "Retrying",
