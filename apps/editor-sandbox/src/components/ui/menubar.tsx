...
// Copied from https://shadcn-solid.netlify.app/docs/components/menubar
...
export const MenubarTrigger = <T extends ValidComponent = "button">(
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      class={cx(
        "focus:bg-accent focus:text-accent-foreground data-[expanded]:bg-accent data-[expanded]:text-accent-foreground flex items-center rounded-sm px-2 py-1 text-sm font-450 outline-hidden select-none",
        props.class,
      )}
      {...rest}
    />
...
export const MenubarGroupLabel = <T extends ValidComponent = "span">(
  ...
  return (
    <MenubarPrimitive.GroupLabel
      ...
      data-inset={props.inset}
      class={cx(
        "px-2 py-1.5 text-sm font-450 data-[inset]:pl-8",
        props.class,
      )}
      {...rest}
    />
