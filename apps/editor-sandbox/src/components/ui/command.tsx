...
// Copied from https://shadcn-solid.netlify.app/docs/components/command
...
export const CommandDialog = (props: CommandDialogProps) => {
  ...
  return (
    <CommandPrimitive.Dialog
      ...
      overlayClassName={cx(
        "data-[expanded]:animate-in data-[closed]:animate-out data-[closed]:fade-out-0 data-[expanded]:fade-in-0 fixed inset-0 z-50 bg-overlay",
        props.overlayClassName,
      )}
      class={cx(
        "bg-popover text-popover-foreground [&_[cmdk-group-heading]]:text-muted-foreground flex h-full w-full flex-col overflow-hidden rounded-md **:data-[slot=command-input-wrapper]:h-12 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-450 [&_[cmdk-group]]:px-2 [&_[cmdk-group]:not([hidden])_~[cmdk-group]]:pt-0 [&_[cmdk-input-wrapper]_svg]:h-5 [&_[cmdk-input-wrapper]_svg]:w-5 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-2 [&_[cmdk-item]]:py-3 [&_[cmdk-item]_svg]:h-5 [&_[cmdk-item]_svg]:w-5",
        props.class,
      )}
      {...rest}
    />
...
export const CommandGroup = (props: CommandGroupProps) => {
  ...
  return (
    <CommandPrimitive.Group
      ...
      class={cx(
        "text-foreground [&_[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 [&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-xs [&_[cmdk-group-heading]]:font-450",
        props.class,
      )}
      {...rest}
    />
